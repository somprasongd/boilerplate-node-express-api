...
import { NotFoundExceptions } from '../../helpers/exceptions';
...
export const findOne = async (req, res, next) => {
  ...
  if (!data) return next(new NotFoundExceptions('The pet with the given ID was not found.'));
...
export const remove = async (req, res, next) => {
  ...
  if (!pet) return next(new NotFoundExceptions('The pet with the given ID was not found.'));
